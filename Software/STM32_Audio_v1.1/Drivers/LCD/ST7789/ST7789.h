...
#define MUSIC_NAME_COLOR 0xD000
...
#define ST7789_BACKLIGHT_On() HAL_GPIO_WritePin(ST7789_BL_PORT, ST7789_BL_PIN, GPIO_PIN_SET)
#define ST7789_BACKLIGHT_Off() HAL_GPIO_WritePin(ST7789_BL_PORT, ST7789_BL_PIN, GPIO_PIN_RESET)
#else
